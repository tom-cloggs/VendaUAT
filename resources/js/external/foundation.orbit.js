;(function ($, window, document, undefined) {
  ...
  Foundation.libs.orbit = {
    ...
    _init: function (idx, slider) {
      ...
      // Adds orbit-slides-container to the ul if it's not there.
      // Failing to add it to the html will result in unflashed content.
    ...
    _init_events: function ($slides_container) {
      ...
      $(window)
        .on('load.fndtn.orbit', function() {
          ...
          // Fixes the flash of unstyled content (https://github.com/zurb/foundation/issues/1707)
